...
-- Description:	Возвращает список изменений по имени пользователя за период
-- =============================================
CREATE FUNCTION [DWHSchema].[GetLogUserName]
(	
...
GRANT SELECT ON [DWHSchema].[GetLogUserName]
